/**
 * @file index.ts
 * @description Custom Image plugin for Yoopta Editor
 * Forked from @yoopta/image with Planneer-specific styling
 * 
 * Features:
 * - Clean, modern UI with Tailwind styling
 * - Full dark mode support using GitHub theme colors
 * - Improved upload placeholder UX
  ...
  parsers: {
    html: {
      ...
      serialize: (element, _text, blockMeta) => {
        ...
        const justify = ALIGNS_TO_JUSTIFY[align as keyof typeof ALIGNS_TO_JUSTIFY] || 'center';
        ...
        return `
          <table style="width:100%;">
            <tbody style="width:100%;">
              <tr>
                <td style="margin-left: ${depth * 20}px; display: flex; width: 100%; justify-content: ${justify}; margin-top: 1rem;">
                  <img data-meta-align="${align}" style="margin: 0 auto; object-fit:${element.props.fit || 'contain'};" data-meta-depth="${depth}" src="${element.props.src}" alt="${element.props.alt}" width="${element.props.sizes?.width}" height="${element.props.sizes?.height}" />
                </td>
              </tr>
            </tbody>
          </table>
...
export { Image as CustomImagePlugin, ImageCommands };
export type { ImageElementProps, ImagePluginOptions, ImageElementMap } from './types';
